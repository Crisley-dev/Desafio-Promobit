                ...
                <div class="card shadow-lg p-3 card-geral">
                    ...
                    <div class="card-body p-3 text-center">
                        ...
                        <div class="mb-sm-6 mt-md-2 pb-3">
                            <table class="table table-hover table-striped table-responsive text-center" id="tb_edit_products">
                                <thead>
                                    <th>ID</th>
                                    <th>Produto</th>
                                    <th>TAG</th>
                                    <th style='display:none'>tag id</th>
                                </thead>
                                <tbody>
                                   <?php foreach($result as $data):
                                    ...
                                    <tr>
                                        ...
                                        <td style='display:none'><?php echo $data['tid'];?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
